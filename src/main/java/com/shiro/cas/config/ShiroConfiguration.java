...
public class ShiroConfiguration {
     ...
     * cas server地址
     */
    public static final String CAS_SERVER_URL_PREFIX = "http://127.0.0.1:8095";
    /**
     * Cas登录页面地址
     */
     ...
     * 当前工程对外提供的服务地址
     */
    public static final String SHIRO_SERVER_URL_PREFIX = "http://127.0.0.1:8096";
    /**
     ...
     */
    public static final String LOGOUT_URL = CAS_LOGOUT_URL + "?service=" + LOGIN_URL;
    /**
     * 登录成功地址
     */
...
//      <!-- 用户授权/认证信息Cache, 采用EhCache 缓存 -->
    ...
    public MyShiroRealm myShiroCasRealm() {
        ...
        // cas登录服务器地址前缀
        realm.setCasServerUrlPrefix(ShiroConfiguration.CAS_SERVER_URL_PREFIX);
        // 客户端回调地址，登录成功后的跳转地址(自己的服务地址)
        realm.setCasService(ShiroConfiguration.SHIRO_SERVER_URL_PREFIX + ShiroConfiguration.CAS_FILTER_URL_PATTERN);
...
/*  // 注册单点登出的listener 的代替方案
    @Bean
    LogoutFilter logoutFilter(){
        LogoutFilter logoutFilter = new LogoutFilter();
        logoutFilter.setRedirectUrl(ShiroConfiguration.LOGOUT_URL);
        return logoutFilter;
    }
*/
