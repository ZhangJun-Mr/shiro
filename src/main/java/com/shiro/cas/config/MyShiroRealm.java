...
import com.shiro.cas.entities.SysPermission;
import com.shiro.cas.entities.SysRole;
import com.shiro.cas.entities.UserInfo;
...
//				principals.getPrimaryPrincipal(); 这种方式也可以获取用户名
        ...
        userInfo.getRoleList().add(new SysRole());

        // 将用户对应的角色和权限信息打包放到AuthorizationInfo中
        for (SysRole role : userInfo.getRoleList()) {
            role.getPermissions().add(new SysPermission());
